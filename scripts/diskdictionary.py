...
disk_dict['MWC_480'] = {'name': 'MWC 480',
                        ...
                        'PA_gofish': 148 + 0.0, #position angle in degrees, corrected for gofish
                        'Teff':8250, #[K], Montesinos et al. (2009)
                        #L_star seems highly uncertain, error -7.8, +20.7 according to Montesinos+09. Liu+19 quote 17.3 LSun,
                        #Simon+01 quote 11.5 LSun
                        'L_star': 21.9, #[solar luminosity], Montesinos et al. (2009).
                        'M_star': 1.8, #[solar masses], Vioque et al. (2018)
                        ...
                        '12CO_extent' : 16, # km/s, measured in v0 images
                        'RA_center' : '04h58m46.27428s',
...
disk_dict['AS_209'] = {'name': 'AS 209',
                       ...
                       '12CO_extent' : 17, # km/s, measured in v0 image
...
disk_dict['IM_Lup'] = {'name': "IM Lup",
                       ...
                       'Teff': 4266, #Kelvin, Alcala et al. 2017
                       ...
                       '12CO_extent' : 12, # km/s, measured in v0 image
...
disk_dict['HD_163296'] = {'name': "HD 163296",
                          ...
                          'Teff': 9332, #Kelvin, Fairlamb et al. 2015
                          ...
                          '12CO_extent' : 21, # km/s, measured in v0 images
